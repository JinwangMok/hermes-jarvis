...
Stage only the manifest/schema/declarative/test files for the leaf. Keep unrelated dirty work out, especially `skills/minerva/SKILL.md`, `src/zeus_os/cli.py`, runtime files, mail-secretary files, `data/`, `state/`, and `credentials/`.
