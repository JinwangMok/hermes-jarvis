...
Use this reference when continuing the ZeusOS repository rearchitecture chain after the Minerva/HOOO bridge and initial script classification leaves.
...
- explicit non-goals: no HOOO migration claim, no runtime cutover, no data/state/credentials migration, no gateway/systemd/cron changes.
