...
INTELLIGENCE_NOTE_DIR = "queries/zeus-os-intelligence"
...
MONTHLY_TIMELINE_NOTE = "queries/zeus-os-monthly-timeline-36m.md"
...
def _write_recent_action_alerts_note(config: PipelineConfig, rows: list[dict], generated_at: str, *, as_of: datetime) -> Path:
    ...
    lines = [
        ...
        'type: query',
        'tags: [zeus-os, intelligence, alerts, inbox, priority]',
        'sources: []',
        'owner: zeus-os',
        'authority: derived',
        'generated: true',
...
def _write_next_day_mail_todos_note(config: PipelineConfig, generated_at: str, *, as_of: datetime) -> Path:
    ...
    lines = [
        ...
        f'updated: {generated_at[:10]}',
        'type: query',
        'tags: [zeus-os, intelligence, todo, mail, priority]',
        'sources: []',
        'owner: zeus-os',
        'authority: derived',
        'generated: true',
...
def _write_important_mail_recommendations_note(config: PipelineConfig, generated_at: str, *, as_of: datetime) -> tuple[Path, list[dict]]:
    ...
    lines = [
        ...
        f'updated: {generated_at[:10]}',
        'type: query',
        'tags: [zeus-os, intelligence, important-mail, recommendations, priority]',
        'sources: []',
        'owner: zeus-os',
        'authority: derived',
        'generated: true',
...
def _write_jongwon_smartx_flow_note(config: PipelineConfig, rows: list[dict], generated_at: str) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, jongwon, smartx, priority]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_jongwon_direct_actions_note(config: PipelineConfig, rows: list[dict], generated_at: str) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, jongwon, actions, priority]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_smartx_weekly_briefing_note(config: PipelineConfig, rows: list[dict], generated_at: str, *, as_of: datetime) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, smartx, weekly, priority]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_jongwon_phase_map_note(config: PipelineConfig, rows: list[dict], generated_at: str) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, jongwon, phase-map, priority]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_jongwon_context_cases_note(config: PipelineConfig, rows: list[dict], generated_at: str) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, jongwon, context, priority]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_interaction_chain_note(config: PipelineConfig, rows: list[dict], generated_at: str) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, chains, priority]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_advisor_action_status_note(config: PipelineConfig, rows: list[dict], generated_at: str) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, advisor, action, priority]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_project_work_items_note(config: PipelineConfig, rows: list[dict], generated_at: str) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, projects, work-items, priority]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_education_teaching_memory_note(config: PipelineConfig, rows: list[dict], generated_at: str) -> Path:
    ...
    lines = [
        ...
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, education, teaching, memory]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def _write_category_notes(config: PipelineConfig, rows: list[dict], generated_at: str) -> dict[str, Path]:
    ...
    for category, items in by_category.items():
        ...
        lines = [
            "---",
            f"title: ZeusOS intelligence category - {category}",
            f"created: {generated_at[:10]}",
            f"updated: {generated_at[:10]}",
            "type: query",
            f"tags: [zeus-os, intelligence, {category}]",
            "sources: []",
            "owner: zeus-os",
            "authority: derived",
            "generated: true",
...
def _write_intelligence_index(
    ...
    *,
    ...
    lines = [
        "---",
        "title: ZeusOS intelligence index",
        f"created: {generated_at[:10]}",
        f"updated: {generated_at[:10]}",
        "type: query",
        "tags: [zeus-os, intelligence, index]",
        "sources: []",
        "owner: zeus-os",
        "authority: derived",
        "generated: true",
...
def generate_daily_intelligence_report(
    ...
    *,
    ...
    frontmatter = render_generated_report_frontmatter(
        title=f"ZeusOS Daily Intelligence {moment.date().isoformat()}",
        ...
        summary=f"Daily generated ZeusOS intelligence report for {moment.date().isoformat()}.",
    )
    lines = [
        f"# {title}",
        "",
